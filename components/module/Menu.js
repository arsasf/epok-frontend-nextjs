      ...
      <div className={`${styles.boxMenuLeft} shadow md`}>
        <div className={styles.listMenuTop}>
          {props.nav ? (
            ...
            <Button className={styles.rowMenu} onClick={handleDashboard}>
              <div className={styles.imgMenu}>
                <Image src="/img/grid.png" width="25px" height="25px" />
              </div>
              <h3 className={styles.textMenu}>Dashboard</h3>
          ...
          {props.transfer ? (
            <Button className={styles.rowMenuActive} onClick={handleTransfer}>
              <div className={styles.imgMenu}>
            ...
            <Button className={styles.rowMenu} onClick={handleTransfer}>
              <div className={styles.imgMenu}>
                <Image src="/img/arrow-up.png" width="25px" height="25px" />
              </div>
              <h3 className={styles.textMenu}>Transfer</h3>
          ...
          {props.topup ? (
            <Button className={styles.rowMenuActive}>
              <div className={styles.imgMenu}>
          ...
          {props.profile ? (
            <Button className={styles.rowMenuActive} onClick={handleProfile}>
              <div className={styles.imgMenu}>
                <Image
            ...
            <Button className={styles.rowMenu} onClick={handleProfile}>
              <div className={styles.imgMenu}>
                <Image
                  src="data:image/svg+xml;base64,"
                  width="25px"
